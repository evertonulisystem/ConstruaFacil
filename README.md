...
Neste projeto, estarei abordando o uso de restAssured no site teste da Petz.
Aqui se encontra uma API para testes com restAssured.
...
* Entendimento do funcionamento de Testes de API com restAssured
* Sera implementado visando teste de CRUD
